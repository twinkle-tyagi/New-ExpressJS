...
function ready () {
    ...
    axios.get(`http://3.90.105.217:3000/?page=${page}`)
    .then( res => {
        //console.log("here");
        //console.log(res);
        pagination(res);
    ...
    axios.get(`http://3.90.105.217:3000/cart/?page=${page}`)
    .then(res => {
...
function addToCartClicked(event, prodID) {
    ...
    axios.post('http://3.90.105.217:3000/cart', {prodID: prodID})
    .then (res => {
        if(res.status === 200) {
            //console.log(obj);
...
function quantityChanged(event) {
    ...
    axios.post('http://3.90.105.217:3000/postUpdateQty', newValue)
    .then(resu => {
        updateCartTotal();
    })
    .catch(err => console.log(err)); */
...
function purchaseClicked() {
    ...
    axios.post('http://3.90.105.217:3000/create-order')
    .then( res => {
